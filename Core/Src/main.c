...
uint32_t Blink1Buffer[ 128 ];
osStaticThreadDef_t Blink1ControlBlock;
const osThreadAttr_t LED_Blink_attributes = {
  .name = "LED_Blink",
  .cb_mem = &Blink1ControlBlock,
  .cb_size = sizeof(Blink1ControlBlock),
  .stack_mem = &Blink1Buffer[0],
  .stack_size = sizeof(Blink1Buffer),
